  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] gap-8 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-2xl">
        <Link href="/projects" className="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-md hover:border-blue-300 hover:bg-blue-50/60 transition-all text-center">
          <div className="font-semibold text-slate-800">프로젝트 관리</div>
          <div className="text-sm text-slate-500 mt-1">FMEA 프로젝트 생성 및 관리</div>
        </Link>
        <Link href="/projects/import" className="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-md hover:border-blue-300 hover:bg-blue-50/60 transition-all text-center">
        ...
        <Link href="/dashboard" className="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-md hover:border-blue-300 hover:bg-blue-50/60 transition-all text-center">
