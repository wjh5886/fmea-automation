...
function ProjectCard({
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-5 hover:border-blue-500 hover:shadow-lg hover:shadow-blue-200/60 hover:-translate-y-0.5 flex items-center justify-between group transition-all">
